...
const PrivacyPolicyContentEs = () => (
  <div className="modal-body fst-italic">
    <p>Última actualización: 20 de Septiembre, 2023</p>
    ...
    <li>
    <p><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Simplest Resumes.</p>
    </li>
    <li>
    ...
    <li>
    <p><strong>Website</strong> refers to Simplest Resumes, accessible from <a href="https://simplestresumes.com" rel="external nofollow noopener" target="_blank">https://simplestresumes.com</a></p>
    </li>
    <li>
    ...
    <ul>
    <li>
    <p>By email: martinsugasti@gmail.com</p>
    </li>
    <li>
    <p>By visiting this page on our website: <a href="https://simplestresumes.com" rel="external nofollow noopener" target="_blank">https://simplestresumes.com</a></p>
    </li>
    </ul>
  </div>
);

export default PrivacyPolicyContentEs;
